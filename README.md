...
2. Панель управления RSS-лентами
...
1. **Модуль сбора данных**:
   - Парсинг RSS-лент с сайта goha.ru
   - Поиск ключевых слов в заголовках и описаниях новостей
   - Сохранение результатов в SQLite БД
   - Автоматическая проверка каждые 5 минут

2. **Веб-интерфейс**:
   - Просмотр найденных новостей (заголовок, текст, ссылка)
   - Управление RSS-лентами (добавление/удаление)
